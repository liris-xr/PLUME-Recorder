...
{
    public static class SkinnedMeshRendererBlendShapeRecorderModuleSettingsProvider
    {
        [SettingsProvider]
        public static SettingsProvider CreateSettingsProvider()
        {
            var settings = SettingsEditor.GetSettings<SkinnedMeshRendererBlendShapeRecorderModuleSettings>();
