...
{
    [BurstCompile]
    public struct MeshFilterCreate : IProtoBurstMessage
    {
        public static readonly FixedString128Bytes TypeUrl = "fr.liris.plume/plume.sample.unity.MeshFilterCreate";
        ...
        public MeshFilterCreate(ComponentIdentifier identifier)
        {
