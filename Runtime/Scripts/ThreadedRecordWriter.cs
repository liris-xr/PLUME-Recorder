...
namespace PLUME
{
    public class ThreadedRecordWriter : IDisposable
    {
        ...
        public ThreadedRecordWriter(SamplePoolManager samplePoolManager, string filepath, bool useCompression, string recordIdentifier, int bufferSize = 4096, bool leaveOpen = false)
        {
            _samplePoolManager = samplePoolManager;
            _writer = new RecordWriter(filepath, recordIdentifier, useCompression, bufferSize, leaveOpen);
